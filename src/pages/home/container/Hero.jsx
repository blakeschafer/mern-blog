    ...
    <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row'>
      ...
      <div className='flex mt-4 flex-col lg:flex-row lg:items-start lg:flex-nowrap lg:gap-x-4 lg:mt-7'>
        ...
        <ul className='flex flex-wrap gap-x-2.5 gap-y-2.5 mt-3 lg:text-sm xl:text-base'>
            <li className='rounded-lg bg-primary bg-opacity-80 px-3 py-1.5 text-black font-semibold'>Education</li>
            <li className='rounded-lg bg-primary bg-opacity-80 px-3 py-1.5 text-black font-semibold'>Journal</li>
            <li className='rounded-lg bg-primary bg-opacity-80 px-3 py-1.5 text-black font-semibold'>Software Development</li>
        </ul>
      </div>
      </div>
